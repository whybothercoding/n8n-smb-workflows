...
4. **Update the Email node** — replace `n8n-alerts@yourcompany.com` with your sending address and `owner@yourcompany.com` with your receiving address.
5. Connect SMTP credential.
